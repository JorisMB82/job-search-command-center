...
const promptSlots: PromptSlot[] = [
  { key: "company_research", label: "Company research", help: "Start here. Decide whether the company is worth pursuing and what the signal may imply." },
  { key: "unposted_role", label: "Unposted role", help: "Use this if the company looks like a possible role-creation or founder's-office target." },
  { key: "proposal_outreach", label: "Proposal outreach", help: "Use this if the company may be better approached as a consulting, advisory, or fractional engagement." },
